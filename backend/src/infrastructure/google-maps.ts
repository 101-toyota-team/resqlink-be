...
export class GoogleMapsRepository implements IMapsRepository {
  ...
  async getDistanceMatrix(
    ...
    const url = `https://maps.googleapis.com/maps/api/distancematrix/jsonorigins=${encodeURIComponent(
      originsQuery
  ...
  async getDirections(
    ...
    const url = `https://maps.googleapis.com/maps/api/directions/jsonorigin=${encodeURIComponent(
      origin
